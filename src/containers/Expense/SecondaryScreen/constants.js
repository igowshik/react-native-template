export const SET_IND_CONEXIONS = '@Expense/SET_IND_CONEXIONS';
export const GET_IND_CONEXIONS = '@Expense/GET_IND_CONEXIONS';
...
export const SET_EXP_REPORT_ITEM = '@Expense/SET_EXP_REPORT_ITEM';
export const SET_EXP_REPORT_ITEM_QUERY = '@Expense/SET_EXP_REPORT_ITEM_QUERY';
export const CREATE_EXP_REPORT_ITEM = '@Expense/CREATE_EXP_REPORT_ITEM';
export const EDIT_EXP_MODAL_VISIBILITY = '@Expense/EDIT_EXP_MODAL_VISIBILITY';

export const DELETE_EXPENSE = '@Expense/DELETE_EXPENSE';
export const TRIGGER_EXP_DELETE = '@Expense/TRIGGER_EXP_DELETE';
